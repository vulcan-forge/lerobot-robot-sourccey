...
class SourcceyRobotAction(_message.Message):
    ...
    untorque_left: bool
    untorque_right: bool
    def __init__(self, left_arm_target_joints: _Optional[_Union[MotorJoint, _Mapping]] = ..., right_arm_target_joints: _Optional[_Union[MotorJoint, _Mapping]] = ..., base_target_position: _Optional[_Union[BasePosition, _Mapping]] = ..., base_target_velocity: _Optional[_Union[BaseVelocity, _Mapping]] = ..., untorque_left: _Optional[bool] = ..., untorque_right: _Optional[bool] = ...) -> None: ...
