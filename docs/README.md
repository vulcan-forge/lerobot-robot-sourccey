# Sourccey documentation

The guides are separated by task so operators do not need to search through a
single large README.

1. [Setup](setup.md) — prepare the controller and install the plugin.
2. [Controlling Sourccey](control.md) — check hardware, start the host, find
